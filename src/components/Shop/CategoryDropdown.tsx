    ...
    <div className="bg-white shadow-1 rounded-lg">
      ...
      <div className={`flex-col gap-3 py-6 pl-6 pr-5.5 ${toggleDropdown ? "flex" : "hidden"}`}>
        ...
        <Link
          href={shopLink}
          className={`${
            isShopActive && "text-blue"
          } group flex items-center justify-between ease-out duration-200 hover:text-blue`}
        >
          <div className="flex items-center gap-2">
            {/* Checkbox vuông giả lập */}
            <div className={`cursor-pointer flex items-center justify-center rounded w-4 h-4 border ${
                isShopActive ? "border-blue bg-blue" : "bg-white border-gray-3"
              }`}>
              <svg className={isShopActive ? "block" : "hidden"} width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div className={`cursor-pointer flex items-center justify-center rounded w-4 h-4 border ${
                  ...
                  <svg className={isSelected ? "block" : "hidden"} width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.33317 2.5L3.74984 7.08333L1.6665 5" stroke="white" strokeWidth="1.94437" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
