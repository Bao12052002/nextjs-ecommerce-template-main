                  ...
                  <div className="flex flex-wrap items-center gap-4">
                   ...
                   <div className="flex items-center gap-2.5">
                    ...
                    >
                      ...
                      >
                         <path d="M16.3125 3.375H1.6875C1.48039 3.375 1.3125 3.20711 1.3125 3V2.0625C1.3125 1.85539 1.48039 1.6875 1.6875 1.6875H16.3125C16.5196 1.6875 16.6875 1.85539 16.6875 2.0625V3C16.6875 3.20711 16.5196 3.375 16.3125 3.375ZM16.3125 9.5625H1.6875C1.48039 9.5625 1.3125 9.39461 1.3125 9.1875V8.25C1.3125 8.04289 1.48039 7.875 1.6875 7.875H16.3125C16.5196 7.875 16.6875 8.04289 16.6875 8.25V9.1875C16.6875 9.39461 16.5196 9.5625 16.3125 9.5625ZM16.3125 15.75H1.6875C1.48039 15.75 1.3125 15.5821 1.3125 15.375V14.4375C1.3125 14.2304 1.48039 14.0625 1.6875 14.0625H16.3125C16.5196 14.0625 16.6875 14.2304 16.6875 14.4375V15.375C16.6875 15.5821 16.5196 15.75 16.3125 15.75Z" fill="" />
                      </svg>
                    </button>
                   </div>
                </div>
