...
const Shop = ({
  ...
  // Cập nhật dữ liệu khi props từ Server thay đổi
  useEffect(() => {
  ...
  const handleSortChange = (value: string) => {
    ...
    switch (value) {
      ...
      case "latest":
      default:
        // Reset về thứ tự ban đầu (cần copy từ initialProducts để tránh reference)
  ...
  // --- LOGIC GIAO DIỆN (Sticky Sidebar) ---
  useEffect(() => {
  ...
  return (
    <>
      <Breadcrumb title={title} pages={["home", "shop"]} />
