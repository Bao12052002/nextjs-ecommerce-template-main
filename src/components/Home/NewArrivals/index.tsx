...
import ProductItem from "@/components/Common/ProductItem"; // Import component hiển thị sản phẩm
import { Product } from "@/types/product"; // Type dữ liệu sản phẩm
      ...
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-7.5 gap-y-9">
          {products && products.length > 0 ? (
            products.map((product) => (
              // Sử dụng prop "product" thay vì "item" để khớp với component ProductItem đã sửa
